...
object BookHtmlRouter {
    fun listEndpoint(ctx: Context) = Utils.query {
        ...
        ctx.render(filePath = "templates/book/list_books.kte", mapOf("books" to books))
    }
    ...
    fun viewEndpoint(ctx: Context) = Utils.query {
        ...
        val book = Book.findById(id = bookId)
            ...
            ?: throw NotFoundResponse(message = "Book not found")
        ctx.render(filePath = "templates/book/view_book.kte", mapOf("book" to book))
    }
    ...
    fun editEndpoint(ctx: Context) = Utils.query {
        ...
        ctx.render(filePath = "templates/book/edit_book.kte", mapOf(
            "book" to book,
            "genres" to genres,
