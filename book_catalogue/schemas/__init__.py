...
__all__ = ["User", "Author", "AuthorRole", "AuthorIdentifiers", "Book", "BookIdentifiers", "Publisher", "Series"]

from book_catalogue.schemas._author import Author, Role as AuthorRole, Identifiers as AuthorIdentifiers
