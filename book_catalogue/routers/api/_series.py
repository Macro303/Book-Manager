...
from book_catalogue.schemas._series import CreateSeries
...
def create_series(new_series: CreateSeries) -> Series:
    with db_session:
        return SeriesController.create_series(title=new_series.title).to_schema()
