...
from book_catalogue.controllers import FormatController
from book_catalogue.responses import ErrorResponse
from book_catalogue.schemas import Format
...
def create_format(new_format: NewFormat) -> Format:
    with db_session:
...
def update_format(format_id: int, updates: NewFormat) -> Format:
    with db_session:
