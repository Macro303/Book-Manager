...
from bookshelf.database.tables import Publisher
...
class PublisherController:
    ...
    @classmethod
    def create_publisher(cls, new_publisher: PublisherIn) -> Publisher:
    ...
    @classmethod
    def update_publisher(cls, publisher_id: int, updates: PublisherIn):
