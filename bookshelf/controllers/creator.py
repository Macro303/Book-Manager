...
from bookshelf.database.tables import Creator
...
class CreatorController:
    ...
    @classmethod
    def create_creator(cls, new_creator: CreatorIn) -> Creator:
    ...
    @classmethod
    def update_creator(cls, creator_id: int, updates: CreatorIn) -> Creator:
