...
from bookshelf.services.google_books.schemas import Book
from bookshelf.services.sqlite_cache import SQLiteCache

MINUTE = 60
LOGGER = logging.getLogger("bookshelf.services.google_books")
...
class GoogleBooks:
    ...
    def __init__(self, timeout: int = 30, cache: SQLiteCache | None = None):
        self.headers = {
            ...
            "User-Agent": f"Bookshelf/{__version__}/{platform.system()}: {platform.release()}",
        }
        self.cache = cache
